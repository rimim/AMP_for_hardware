...
def play(args):
    ...
    for i in range(num_frames):
        ...
        amp_foot_obs = env.get_amp_observations()[0, 16:22]
        ...
        dof_vel_obs = env.get_amp_observations()[0, 28:44]
        ...
        base_lin_vel_obs = env.get_amp_observations()[0, 22:25]
        ...
        base_ang_vel_obs = env.get_amp_observations()[0, 25:28]
